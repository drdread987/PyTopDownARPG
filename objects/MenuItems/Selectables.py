...
class Quit(objects.bases.BaseDoodad):
    def __init__(self, x, y):
        ...
        self.original_image = pygame.image.load("res/Quit.png")
        self.highlighted_image = pygame.image.load("res/Quit_highlighted.png")
    ...
    def step(self, dt, obj_handler, keys, mouse_info):
        super().step(dt, obj_handler, keys, mouse_info)
...
class NewGame(objects.bases.BaseDoodad):
    ...
    def __init__(self, x, y):
        ...
        self.original_image = pygame.image.load("res/New_game.png")
        self.highlighted_image = pygame.image.load("res/New_game_highlighted.png")
        self.image = self.original_image
        self.height = 100
        self.width = 400
